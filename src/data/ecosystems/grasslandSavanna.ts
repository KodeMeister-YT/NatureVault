...
export const grasslandSavannaVault: BiomeDefinition = {
  ...
  objects: [
    ...
    { id: 'savanna-waterhole', kind: 'pond', biodiversityCategory: 'water', name: 'Kalahi Watering Hole', position: [3, 0, -1], presentInYears: [1995, 2015, 2026, 2050], description: 'A shallow watering hole that draws grazing herds from across the plain, especially in the dry season.', ecologicalRole: 'The plain\u2019s central water source, supporting grazers, birds, and the surrounding grassland\u2019s soil moisture.', historicalChange: 'Dry-season levels have dropped as year-round livestock use has increased demand on the hole.', featureRadius: 4, trophicRole: 'producer', habitat: 'Central savanna watering hole', environmentalPressures: ['Year-round livestock demand', 'Lower dry-season recharge'] },
