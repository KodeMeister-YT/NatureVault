...
export const tropicalForestVault: BiomeDefinition = {
  ...
  objects: [
    ...
    { id: 'tropical-waterfall-1', kind: 'waterfall', biodiversityCategory: 'water', name: 'Esmeralda Falls', position: [0, 0, -6], presentInYears: [1995, 2015, 2026, 2050], description: 'A year-round waterfall cascading into a clear pool at the heart of the reserve.', ecologicalRole: 'Feeds the reserve\u2019s streams and pools, sustaining amphibians, birds, and the humid microclimate the canopy depends on.', historicalChange: 'Dry-season flow has weakened as upstream canopy loss has reduced water retention in the watershed.', featureRadius: 7, habitat: 'Forest waterfall and pool', environmentalPressures: ['Upstream canopy loss reducing water retention', 'Weaker dry-season flow'] },
